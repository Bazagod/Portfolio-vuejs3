    ...
    <section class="text-white mt-18" id="about">
        ...
        <div class="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 z-1">
            ...
            <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full" data-aos="flip-right">
                ...
                <p class="text-base lg:text-lg mt-8 py-8"> I discovered frontend development as a way to combine my love for creativity and technology. What drives me the most is turning complex ideas into simple, beautiful, and user-friendly experiences. I specialize in Vuejs and CSS animations, always looking for ways to improve performance and accessibility. I believe that great interfaces are the result of empathy, collaboration, and attention to detail. I’m constantly learning and enjoy exploring new tools and trends to stay ahead in this fast-evolving field.
                </p>
...
const education=ref([
    ...
    },
    {
        ...
        program:'High School Diploma in General Humanities',
        year:'2017-2021'
    }
])
</script>

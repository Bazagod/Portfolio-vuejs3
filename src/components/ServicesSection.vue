...
const services =ref([
    {
        ...
        description:'Taking your project from the first step all the way to a live platform.'
    },
    {
        id:2,
        ...
        description:'Making your software easier to use, one well-written document at a time.'
    },
    {
        id:3,
        icon:'https://img.icons8.com/ios-filled/100/ffffff/web-design.png',
        name:'Web Design',
        description:'I design all types of graphics for websites and edit any content as needed.'
    },
    ])
</script>
